...
const APPS = [
  { id: "gitea",      title: "Gitea",          desc: "Git repository hosting and code review",                            logo: logoGitea },
  { id: "airflow",    title: "Apache Airflow",  desc: "Data workflow orchestration dashboard",                             logo: logoAirflow },
  { id: "argocd",     title: "ArgoCD",          desc: "GitOps continuous delivery platform",                               logo: logoArgocd },
  { id: "litellm",    title: "LLM Playground",  desc: "Interact with deployed language models",                            logo: logoLitellm, logoDark: logoLitellmDark },
  { id: "chat",       title: "Chat",            desc: "Team collaboration chat workspace",                                 logo: logoChat },
  { id: "mlflow",     title: "MLflow",          desc: "ML experiment and model lifecycle management",                      logo: logoMlflow, logoDark: logoMlflowDark },
  { id: "jupyterhub", title: "JupyterHub",      desc: "Multi-user Jupyter Notebook environments",                          logo: logoJupyterhub },
  { id: "postgresql", title: "PostgreSQL",      desc: "Relational database management system",                             logo: logoPostgresql },
  { id: "langfuse",   title: "Langfuse",        desc: "Observability and analytics for LLM apps",                          logo: logoLangfuse },
];
...
export function PlatformAppsPage({ onNavigate }: PlatformAppsPageProps) {
  ...
  const [checkedId, setCheckedId] = useState<string | null>("chat");
  ...
  return (
    <div style={{ display: "flex", height: "100%", overflow: "hidden" }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
        <AppGnb
          breadcrumbs={[
            { label: "Platform Apps", icon: <Icon name="Platform" size={20} color={colors.icon.secondary} /> },
          ]}
        />

        <main style={{ flex: 1, overflow: "auto", padding: "32px 40px" }}>
          <div style={{ marginBottom: 32 }}>
            <h1 style={{ fontFamily: "'Pretendard', sans-serif", fontSize: 24, fontWeight: 700, lineHeight: "32px", color: colors.text.primary, marginBottom: 8 }}>
              Platform apps
            </h1>
            <p style={{ fontFamily: "'Pretendard', sans-serif", fontSize: 14, fontWeight: 400, lineHeight: "20px", color: colors.text.secondary }}>
            ...
            {APPS.map((app) => {
              ...
              return (
                <GridCard
                  ...
                  onClick={() => setCheckedId((id) => (id === app.id ? null : app.id))}
                >
                  <img
                    src={logoSrc}
                    alt={app.title}
